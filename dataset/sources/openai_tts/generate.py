#!/usr/bin/env python3
"""openai_tts generation runner — see common/ttsgen.py for the safety model.
...
from common.ttsgen import cli, OpenAIProvider  # noqa: E402

APPROVED_HASH: str | None = (
    "b63b5940ea276e114713f6fc6d7f0147df499d4e7815ebb099d839bf389fa747"
)  # approved 2026-06-04

if __name__ == "__main__":
    cli(SRC_DIR, "openai", lambda key: OpenAIProvider(key), APPROVED_HASH,
